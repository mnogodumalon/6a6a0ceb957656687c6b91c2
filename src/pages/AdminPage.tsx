...
const RAEUME_FIELDS = [
  ...
  { key: 'ausstattung', label: 'Ausstattung', type: 'multiplelookup/checkbox', options: [{ key: 'klavier', label: 'Klavier' }, { key: 'fluegel', label: 'Flügel' }, { key: 'schlagzeug', label: 'Schlagzeug' }, { key: 'gitarrenverstaerker', label: 'Gitarrenverstärker' }, { key: 'pa_anlage', label: 'PA-Anlage' }, { key: 'whiteboard', label: 'Whiteboard' }, { key: 'spiegel', label: 'Spiegel' }, { key: 'tonstudio', label: 'Tonstudio-Ausstattung' }] },
  { key: 'bemerkungen_raum', label: 'Bemerkungen', type: 'string/textarea' },
  { key: 'verfuegbar', label: 'Raum verfügbar', type: 'bool' },
];
const DOZENTEN_FIELDS = [
  ...
  { key: 'fachbereiche', label: 'Fachbereiche / Instrumente', type: 'multiplelookup/checkbox', options: [{ key: 'klavier', label: 'Klavier' }, { key: 'gitarre', label: 'Gitarre' }, { key: 'schlagzeug', label: 'Schlagzeug' }, { key: 'violine', label: 'Violine' }, { key: 'cello', label: 'Cello' }, { key: 'querfloete', label: 'Querflöte' }, { key: 'saxophon', label: 'Saxophon' }, { key: 'trompete', label: 'Trompete' }, { key: 'gesang', label: 'Gesang' }, { key: 'musiktheorie', label: 'Musiktheorie' }, { key: 'komposition', label: 'Komposition' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  { key: 'qualifikationen', label: 'Qualifikationen', type: 'string/textarea' },
  { key: 'beschaeftigungsart', label: 'Beschäftigungsart', type: 'lookup/radio', options: [{ key: 'festangestellt', label: 'Festangestellt' }, { key: 'honorar', label: 'Honorarbasis' }, { key: 'ehrenamtlich', label: 'Ehrenamtlich' }] },
  { key: 'eintrittsdatum', label: 'Eintrittsdatum', type: 'date/date' },
  { key: 'bemerkungen_dozent', label: 'Bemerkungen', type: 'string/textarea' },
];
const KURSEWORKSHOPS_FIELDS = [
  { key: 'titel', label: 'Titel', type: 'string/text' },
  { key: 'kurstyp', label: 'Typ', type: 'lookup/radio', options: [{ key: 'kurs', label: 'Kurs' }, { key: 'workshop', label: 'Workshop' }] },
  ...
  { key: 'wochentag_uhrzeit', label: 'Wochentag & Uhrzeit (regelmäßig)', type: 'string/text' },
  { key: 'max_teilnehmer', label: 'Maximale Teilnehmerzahl', type: 'number' },
  { key: 'preis', label: 'Preis (€)', type: 'number' },
  { key: 'status_kurs', label: 'Status', type: 'lookup/radio', options: [{ key: 'aktiv', label: 'Aktiv' }, { key: 'inaktiv', label: 'Inaktiv' }, { key: 'abgeschlossen', label: 'Abgeschlossen' }, { key: 'geplant', label: 'Geplant' }] },
];
const TEILNEHMER_FIELDS = [
  ...
  { key: 'notfall_name', label: 'Notfallkontakt – Name', type: 'string/text' },
  { key: 'notfall_telefon', label: 'Notfallkontakt – Telefon', type: 'string/tel' },
  { key: 'anmerkungen_tn', label: 'Anmerkungen', type: 'string/textarea' },
];
...
const ZAHLUNGEN_FIELDS = [
  ...
  { key: 'zahlungsart', label: 'Zahlungsart', type: 'lookup/select', options: [{ key: 'bar', label: 'Barzahlung' }, { key: 'ueberweisung', label: 'Überweisung' }, { key: 'sepa', label: 'SEPA-Lastschrift' }, { key: 'online', label: 'Online-Zahlung' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  { key: 'zahlungsstatus', label: 'Zahlungsstatus', type: 'lookup/radio', options: [{ key: 'offen', label: 'Offen' }, { key: 'bezahlt', label: 'Bezahlt' }, { key: 'teilbezahlt', label: 'Teilbezahlt' }, { key: 'erstattet', label: 'Erstattet' }] },
  { key: 'notizen_zahlung', label: 'Notizen', type: 'string/textarea' },
];
