...
export function TeilnehmerDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: TeilnehmerDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'geburtsdatum': (
      <div key="geburtsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="geburtsdatum"
          placeholder="Wann ist der Geburtstag?"
          mode="date"
    ...
    'anmerkungen_tn': (
      <div key="anmerkungen_tn" className="space-y-1.5">
        <Label htmlFor="anmerkungen_tn">Anmerkungen</Label>
        <Textarea
          id="anmerkungen_tn"
          placeholder="Besondere Bedürfnisse, Hinweise, Allergien..."
          value={fields.anmerkungen_tn ?? ''}
          onChange={e => setFields(f => ({ ...f, anmerkungen_tn: e.target.value }))}
          rows={3}
        />
      </div>
    ),
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "geburtsdatum": "Geburtsdatum", "email": "E-Mail-Adresse", "telefon": "Telefonnummer", "strasse": "Straße", "hausnummer": "Hausnummer", "plz": "Postleitzahl", "ort": "Ort", "notfall_name": "Notfallkontakt – Name", "notfall_telefon": "Notfallkontakt – Telefon", "anmerkungen_tn": "Anmerkungen"};
