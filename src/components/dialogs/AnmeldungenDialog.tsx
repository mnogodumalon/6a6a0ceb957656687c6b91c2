...
export function AnmeldungenDialog({ open, onClose, onSubmit, defaultValues, recordId, teilnehmerList, kurseWorkshopsList, enablePhotoScan = true, enablePhotoLocation = true }: AnmeldungenDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'teilnehmer': (
      <div key="teilnehmer" className="space-y-1.5">
        ...
        <Combobox
          id="teilnehmer"
          placeholder="Teilnehmer aus Liste wählen"
    ...
    'kurs': (
      <div key="kurs" className="space-y-1.5">
        <Label htmlFor="kurs">Kurs / Workshop <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Combobox
          id="kurs"
          placeholder="Kurs oder Workshop wählen"
    ...
    'anmeldedatum': (
      <div key="anmeldedatum" className="space-y-1.5">
        ...
        <DatePicker
          id="anmeldedatum"
          placeholder="Anmeldedatum eingeben"
          mode="date"
    ...
    'status_anmeldung': (
      <div key="status_anmeldung" className="space-y-1.5">
        <Label htmlFor="status_anmeldung">Anmeldestatus <span className="text-destructive" aria-hidden="true">*</span></Label>
  ...
  const FIELD_LABELS: Record<string, string> = {"teilnehmer": "Teilnehmer", "kurs": "Kurs / Workshop", "anmeldedatum": "Anmeldedatum", "status_anmeldung": "Anmeldestatus", "bemerkungen_anmeldung": "Bemerkungen"};
  const CURRENCY_KEYS = new Set<string>([]);
  // Applookup-Referenz-Labels: pro applookup-Feld in dieser Form (ownKey)
  // eine Map { lookupKey: label } für ALLE Felder des Target-Schemas. Wird
  // beim Render-Walk gefiltert auf die in der computed-Formel tatsächlich
  // referenzierten lookupKeys (siehe applookupRefs unten).
  const APPLOOKUP_LABELS: Record<string, Record<string, string>> = {"teilnehmer": {"vorname": "Vorname", "nachname": "Nachname", "geburtsdatum": "Geburtsdatum", "email": "E-Mail-Adresse", "telefon": "Telefonnummer", "strasse": "Straße", "hausnummer": "Hausnummer", "plz": "Postleitzahl", "ort": "Ort", "notfall_name": "Notfallkontakt – Name", "notfall_telefon": "Notfallkontakt – Telefon", "anmerkungen_tn": "Anmerkungen"}, "kurs": {"titel": "Titel", "kurstyp": "Typ", "beschreibung": "Beschreibung", "niveau": "Niveau", "dozent": "Dozent", "raum": "Raum", "startdatum": "Startdatum und -uhrzeit", "enddatum": "Enddatum und -uhrzeit", "wochentag_uhrzeit": "Wochentag & Uhrzeit (regelmäßig)", "max_teilnehmer": "Maximale Teilnehmerzahl", "preis": "Preis (€)", "status_kurs": "Status"}};
